...
class HasilPengajar : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hasil_pengajar)
        firebaseAuth = FirebaseAuth.getInstance()
        layoutku = findViewById(R.id.rv_dataKomunHasilPeng)
    ...
    private fun loadMeNow(){
        ...
        val myA = AdapterHasilPengajar(ambilDatabase)
