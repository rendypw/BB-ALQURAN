...
class DataPelajarHasilPengajar : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_data_pelajar_hasil_pengajar)
    ...
    private fun loadMeNow(){
        ...
        val myA = AdapterDataPelajarHasilPengajar(ambilDatabase)
